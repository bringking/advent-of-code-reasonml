...
function drawLine(vectors) {
  return $$Array.fold_left((function (lineSegments, currentVector) {
                ...
                var distance = currentVector[1];
                var endY = endPoint[1];
                var endX = endPoint[0];
                switch (currentVector[0]) {
                  case "D" :
                      return $$Array.append(lineSegments, /* array */[/* array */[
                                    /* tuple */[
                                      endX,
                                      endY
                                    ],
